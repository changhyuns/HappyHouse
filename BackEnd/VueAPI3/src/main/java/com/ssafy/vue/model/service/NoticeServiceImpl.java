...
public class NoticeServiceImpl implements NoticeService {
	...
	public int getPrev(int noticeno) throws Exception {
		return sqlSession.getMapper(NoticeMapper.class).getPrev(noticeno);
	}
	
	@Override
	public int getNext(int noticeno) throws Exception {
		return sqlSession.getMapper(NoticeMapper.class).getNext(noticeno);
	}
	...
	public List<GalleryDto> getFile(int noticeno) throws Exception {
		return sqlSession.getMapper(NoticeMapper.class).getFile(noticeno);
	}
